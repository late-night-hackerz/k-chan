...
<Card.Root>
	<Card.Header>Image here</Card.Header>
	<Card.Content class="pt-6">
		<span class="">
			Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique ab placeat veniam! Id
			velit, ullam architecto error vitae cupiditate eligendi?
		</span>
	</Card.Content>
	<Card.Footer class="flex w-full justify-end gap-2">
		<Toggle class="rounded-full border border-input">
			<svg
